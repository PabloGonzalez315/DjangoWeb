...
def create_estudiantes(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "estudiantesCRUD/read_estudiantes.html",
...
def read_estudiantes(request):
    ...
    return render(
        request, "estudiantesCRUD/read_estudiantes.html", {"estudiantes": estudiantes}
    )
...
def update_estudiantes(request, estudiante_id): 
    ...
    else: formulario = form_estudiantes(initial={'nombre': estudiante.nombre, 'apellido': estudiante.apellido, 'email': estudiante.email}) 
